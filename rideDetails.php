                                ...
                                <table class="table table-bordered table-striped">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td bgcolor="#D3D3D3" colspan="1"><strong>Origin</strong></td>
                                            <td colspan="2 "><?php echo $origin ?></td>
                                        </tr>

                                         <tr>
                                            <th bgcolor="#D3D3D3 ">Destination</th>
                                            <td colspan="2 "><?php echo $destination ?></td>

                                            <td bgcolor="#D3D3D3 " colspan="1 "><strong>Vehicle Type</strong></td>
                                             <td colspan="2 "><?php echo $vehicleType ?></td>
                                        </tr> 

                                        <tr>
                                            <th bgcolor="#D3D3D3 ">Available Seats</th>
                                            <td colspan="2 "><?php echo $availableSeats ?></td>

                                            <td bgcolor="#D3D3D3 " colspan="1 "><strong>Driver</strong></td>
                                             <td colspan="2 "><?php echo $driver ?></td>
                                        </tr>  
                                        ...
                                        <tr>
                                            ...
                                            <td bgcolor="#D3D3D3 " colspan="1 "><strong> Fare </strong></td>
                                             <td colspan="2 "><?php echo $fare ?></td>
                                        </tr> 
                                    </tbody>
                                </table>
                                <div class="well ">
                                <?php echo '<a href="bookRide.php?id=' . $id. ' "><button type="button " class="btn
                                                btn-default ">Book Ride</button></a>';?>
